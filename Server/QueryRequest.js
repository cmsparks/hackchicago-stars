...
function getRadialChunk(res, MIN_RA, MAX_RA, MIN_PARALLAX, MAX_PARALLAX, MIN_DEC, MAX_DEC) {
	...
	request(options, function(error, response, body) {
		...
		console.log(body)
		sendable = JSON.parse(body); 
		res.write(JSON.stringify(sendable.data));
		res.end();
	});
}
